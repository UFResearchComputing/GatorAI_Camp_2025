...
if %errorlevel% neq 0 (
    ...
    if exist "%USERPROFILE%\miniconda3\Scripts\conda.exe" (
        ...
        echo [INFO] Found conda at: %USERPROFILE%\miniconda3\Scripts\conda.exe
        goto :conda_found
    )
    ...
    if exist "C:\miniconda3\Scripts\conda.exe" (
        ...
        echo [INFO] Found conda at: C:\miniconda3\Scripts\conda.exe
        goto :conda_found
    )
    ...
    if exist "%USERPROFILE%\anaconda3\Scripts\conda.exe" (
        ...
        echo [INFO] Found conda at: %USERPROFILE%\anaconda3\Scripts\conda.exe
        goto :conda_found
    )
    ...
    if exist "C:\anaconda3\Scripts\conda.exe" (
        ...
        echo [INFO] Found conda at: C:\anaconda3\Scripts\conda.exe
        goto :conda_found
    )
    ...
    echo [DEBUG] conda_cmd variable: !conda_cmd!
) else (
    set "conda_cmd=conda"
)
